...
|---------------|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| US-01         | Ubicación de inmuebles  | Como freelancer, quiero encontrar la ubicación de los inmuebles para conocer los lugares más cercanos o convenientes                           | **Escenario 1:** Encontrar inmueble por ubicación  **Dado que** el freelancer busca un inmueble por ubicación  **Entonces** se muestra el inmueble con la ubicación seleccionada   | EP-01   |
